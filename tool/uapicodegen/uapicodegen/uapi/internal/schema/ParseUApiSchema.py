...
def parse_uapi_schema(
    ...
    from ...internal.schema.ApplyErrorToParsedTypes import apply_error_to_parsed_types
    from ...internal.schema.CatchErrorCollisions import catch_error_collisions
    from ...internal.schema.FindMatchingSchemaKey import find_matching_schema_key
    from ...internal.schema.FindSchemaKey import find_schema_key
    ...
    from ...internal.schema.ParseErrorType import parse_error_type
    from ...internal.schema.ParseHeadersType import parse_headers_type
    ...
    from ...internal.types.UHeaders import UHeaders
    from ...internal.schema.CatchHeaderCollisions import catch_header_collisions
    ...
    try:
        catch_header_collisions(u_api_schema_document_name_to_pseudo_json, header_keys,
                                schema_keys_to_index, schema_keys_to_document_names, uapi_schema_document_names_to_json)
    except UApiSchemaParseError as e:
        parse_failures.extend(e.schema_parse_failures)
