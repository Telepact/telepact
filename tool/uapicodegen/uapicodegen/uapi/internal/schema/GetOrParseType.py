...
def get_or_parse_type(path: list[object], type_name: str, ctx: 'ParseContext') -> 'UType':
    ...
    from ...internal.types.UBoolean import UBoolean
    from ...internal.types.UInteger import UInteger
    from ...internal.types.UNumber import UNumber
    from ...internal.types.UObject import UObject
    from ...internal.types.UString import UString
    from ...internal.types.UMockCall import UMockCall
    from ...internal.types.UMockStub import UMockStub
    from ...internal.types.USelect import USelect
    from ...internal.types.UAny import UAny
