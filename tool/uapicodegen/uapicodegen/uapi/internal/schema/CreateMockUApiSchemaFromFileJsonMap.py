...
def create_mock_uapi_schema_from_file_json_map(json_documents: dict[str, str]) -> 'MockUApiSchema':
    from ...internal.schema.GetMockUApiJson import get_mock_uapi_json
    from ...internal.schema.CreateUApiSchemaFromFileJsonMap import create_uapi_schema_from_file_json_map
