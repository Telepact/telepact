...
- continue with [Learn by Example: Minimum server](../learn-by-example/running-our-own-server/minimum-server.md)
...
- [Auth Guide](./auth.md)
- [Learn by Example: Auth](../learn-by-example/auth/auth.md)
- [Learn by Example: Server auth](../learn-by-example/running-our-own-server/server-auth.md)
- [Learn by Example: Managed auth](../learn-by-example/running-our-own-server/managed-auth.md)
