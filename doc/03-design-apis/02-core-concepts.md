...
For the full language, see the [Schema Writing Guide](../01-schema-writing-guide.md).
...
- [Transport Guide](../04-build-clients-and-servers/01-transport-guide.md)
...
- [Learn by Example: Functions](../02-learn-by-example/02-schema/08-functions.md)
...
- [Learn by Example: Select](../02-learn-by-example/03-opt-in-features/12-select.md)
...
- [Learn by Example: Binary](../02-learn-by-example/03-opt-in-features/13-binary.md)
- [Learn by Example: Automatic binary negotiation](../02-learn-by-example/06-using-telepact-client-library-code/20-automatic-binary-negotiation.md)

## Where to go next

- If you are designing an API, go to the [Schema Writing Guide](../01-schema-writing-guide.md).
- If you are building a client, go to [Client Paths](../04-build-clients-and-servers/02-client-paths.md).
- If you are building a server, go to [Server Paths](../04-build-clients-and-servers/03-server-paths.md).
- If you want the CLI and related workflows, go to [Tooling Workflow](../04-build-clients-and-servers/04-tooling-workflow.md).
