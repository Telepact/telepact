...
- [Learn by Example: Functions](../learn-by-example/schema/functions.md)
...
- [Learn by Example: Select](../learn-by-example/opt-in-features/select.md)
...
- [Learn by Example: Binary](../learn-by-example/opt-in-features/binary.md)
- [Learn by Example: Automatic binary negotiation](../learn-by-example/using-telepact-client-library-code/automatic-binary-negotiation.md)
