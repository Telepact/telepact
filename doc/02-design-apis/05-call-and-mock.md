# Call and mock extensions

This page covers the Telepact extensions used by mock servers and verification workflows. For the broader extension model, see the [extensions overview](./03-extensions.md).
