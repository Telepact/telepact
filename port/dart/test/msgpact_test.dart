...
import 'package:msgpact/msgpact.dart';
...
void main() {
  group('Server', () {
    test('should process request message bytes', () async {
      ...
      print("Encoding json");
      final msgpactJson = jsonEncode(msgpactPseudoJson);
      print('Creating MsgPactSchema');
      final msgpactSchema = MsgPactSchema.fromJson(msgpactJson);
      print('MsgPactSchema created: $msgpactSchema');
      ...
      final server = Server(msgpactSchema, handler.toJS, serverOptions);
