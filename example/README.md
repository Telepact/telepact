...
- [py-performance](./py-performance/README.md) - Python harness that measures steady-state serialization costs, payload sizes, network estimates, and client-side tuning options
...
- [ts-simple-auth](./ts-simple-auth/README.md) - Minimal TypeScript demo that talks to a Python Telepact server with hard-coded auth
