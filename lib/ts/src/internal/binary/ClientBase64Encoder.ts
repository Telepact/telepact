...
export class ClientBase64Encoder extends Base64Encoder {
    decode(message: object[]): object[] {
        measureSerializerStage('deserialize.base64.clientDecode', () => clientBase64Decode(message));
        return message;
    }

    encode(message: object[]): object[] {
        measureSerializerStage('serialize.base64.clientEncode', () => clientBase64Encode(message));
        return message;
    }
}
