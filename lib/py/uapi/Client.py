...
class Client:
    class Options:
        def __init__(self) -> None:
            ...
            self.use_json_for_request = True
    ...
    def __init__(self, adapter: Callable[['Message', 'Serializer'], Awaitable['Message']], options: 'Options'):
        ...
        self.use_json_for_request = options.use_json_for_request
    ...
    async def request(self, request_message: 'Message') -> 'Message':
        ...
        return await process_request_object(request_message, self.adapter, self.serializer, self.timeout_ms_default, self.use_binary_default, self.use_json_for_request)
