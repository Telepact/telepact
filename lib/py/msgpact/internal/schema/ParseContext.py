...
class ParseContext:
    document_name: str
    msgpact_schema_document_names_to_pseudo_json: dict[str, list[object]]
    ...
    def __init__(self, document_name: str, msgpact_schema_document_names_to_pseudo_json: dict[str, list[object]],
                 msgpact_schema_document_names_to_json: dict[str, str],
        ...
        self.msgpact_schema_document_names_to_pseudo_json = msgpact_schema_document_names_to_pseudo_json
        self.msgpact_schema_document_names_to_json = msgpact_schema_document_names_to_json
    ...
    def copy(self, document_name: Optional[str] = None) -> 'ParseContext':
        return ParseContext(document_name if document_name is not None else self.document_name,
                            self.msgpact_schema_document_names_to_pseudo_json, self.msgpact_schema_document_names_to_json,
