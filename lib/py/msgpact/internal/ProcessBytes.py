...
async def process_bytes(request_message_bytes: bytes, serializer: 'Serializer', msgpact_schema: 'MsgPactSchema',
    ...
    try:
        request_message = parse_request_message(
            request_message_bytes, serializer, msgpact_schema, on_error)
        ...
        response_message = await handle_message(
            request_message, msgpact_schema, handler, on_error)
