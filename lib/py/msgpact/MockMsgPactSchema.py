...
class MockMsgPactSchema:
    ...
    @staticmethod
    def from_json(json: str) -> 'MockMsgPactSchema':
        from .internal.schema.CreateMockMsgPactSchemaFromFileJsonMap import create_mock_vers_api_schema_from_file_json_map
        return create_mock_vers_api_schema_from_file_json_map({"auto_": json})

    @staticmethod
    def from_file_json_map(file_json_map: dict[str, str]) -> 'MockMsgPactSchema':
        from .internal.schema.CreateMockMsgPactSchemaFromFileJsonMap import create_mock_vers_api_schema_from_file_json_map
        return create_mock_vers_api_schema_from_file_json_map(file_json_map)

    @staticmethod
    def from_directory(directory: str) -> 'MockMsgPactSchema':
        from .internal.schema.CreateMockMsgPactSchemaFromFileJsonMap import create_mock_vers_api_schema_from_file_json_map
