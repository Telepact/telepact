...
def server_binary_decode(message: list[object], binary_encoder: 'BinaryEncoding') -> list[object]:
    ...
    from ...internal.binary.BinaryPlan import decode_request_body
    ...
    message_body: dict[str, object] = decode_request_body(
        encoded_message_body, binary_encoder, headers.get("@pac_") is True)
