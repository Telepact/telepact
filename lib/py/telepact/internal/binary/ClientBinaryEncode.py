...
def client_binary_encode(message: list[object], binary_encoding_cache: 'BinaryEncodingCache',
    ...
    from ...internal.binary.BinaryPlan import encode_request_body
    ...
    final_encoded_message_body = encode_request_body(message_body, binary_encoding, headers.get("@pac_") == True)
