...
class ParseContext:
    ...
    def __init__(self, document_name: str, telepact_schema_document_names_to_pseudo_json: dict[str, list[object]],
                 ...
                 all_parse_failures: list['SchemaParseFailure'], failed_types: set[str], top_level: bool) -> None:
    ...
    def copy(self, document_name: Optional[str] = None, top_level: Optional[bool] = None) -> 'ParseContext':
        return ParseContext(document_name if document_name is not None else self.document_name,
                            ...
                            top_level if top_level is not None else self.top_level)
