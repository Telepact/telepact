...
async def handle_create_stub(request_message: 'Message', stubs: list['MockStub']) -> 'Message':
...
async def handle_verify(request_message: 'Message', invocations: list['MockInvocation']) -> 'Message':
...
async def handle_verify_no_more_interactions(invocations: list['MockInvocation']) -> 'Message':
...
async def handle_clear_calls(invocations: list['MockInvocation']) -> 'Message':
    invocations.clear()
    return Message({}, {"Ok_": {}})


async def handle_clear_stubs(stubs: list['MockStub']) -> 'Message':
    stubs.clear()
    return Message({}, {"Ok_": {}})


async def handle_set_random_seed(request_message: 'Message', random: 'RandomGenerator') -> 'Message':
    argument = request_message.get_body_payload()
...
async def handle_auto_mock_function(request_message: 'Message', stubs: list['MockStub'], invocations: list['MockInvocation'],
    ...
    if definition is not None:
        ...
        use_blueprint_value = True
        include_optional_fields = enable_optional_field_generation
        always_include_required_fields = True
