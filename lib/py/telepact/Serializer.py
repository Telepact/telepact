...
class Serializer:
    ...
    def __init__(self, serialization_impl: Serialization, base64_encoder: 'Base64Encoder'):
    ...
    def serialize(self, message: Message) -> bytes:
        ...
        return serialize_internal(message, self.base64_encoder, self.serialization_impl)
    ...
    def deserialize(self, message_bytes: bytes) -> Message:
        ...
        return deserialize_internal(message_bytes, self.serialization_impl, self.base64_encoder)
