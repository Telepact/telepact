...
class Serializer:
    ...
    def __init__(
        self,
        serialization_impl: Serialization,
        binary_encoder: BinaryEncoder,
        base64_encoder: 'Base64Encoder',
        measurement_observer: SerializerMeasurementObserver | None = None,
    ):
        self.serialization_impl = serialization_impl
        self.binary_encoder = binary_encoder
        self.base64_encoder = base64_encoder
        self.measurement_observer = measurement_observer
    ...
    def serialize(self, message: Message) -> bytes:
        ...
        return serialize_internal(message, self.binary_encoder, self.base64_encoder, self.serialization_impl, self.measurement_observer)
    ...
    def deserialize(self, message_bytes: bytes) -> Message:
        ...
        return deserialize_internal(message_bytes, self.serialization_impl, self.binary_encoder, self.base64_encoder, self.measurement_observer)
