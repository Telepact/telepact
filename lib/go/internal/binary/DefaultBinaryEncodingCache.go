...
func (c *DefaultBinaryEncodingCache) Add(checksum int, binaryEncodingMap map[string]int, packedSites []BinaryPackSiteData) {
	c.mu.Lock()
	defer c.mu.Unlock()
	...
	encoding := NewBinaryEncoding(binaryEncodingMap, checksum, packedSites)
