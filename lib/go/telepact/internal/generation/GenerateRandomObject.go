...
func GenerateRandomObject(blueprintValue any, useBlueprintValue bool, typeParameters []*types.TTypeDeclaration, ctx *GenerateContext) map[string]any {
	...
	if useBlueprintValue {
		startingObj := toStringAnyMap(blueprintValue)
