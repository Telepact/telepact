...
class RandomGenerator {
  ...
  RandomGenerator(int collectionLengthMin, int collectionLengthMax)
      : _instance = callConstructor(getProperty(_npmPackage, 'RandomGenerator'), [collectionLengthMin, collectionLengthMax]);
...
class DefaultClientBinaryStrategy implements ClientBinaryStrategy {
  ...
  DefaultClientBinaryStrategy()
      : _instance = callConstructor(getProperty(_npmPackage, 'DefaultClientBinaryStrategy'), []);
...
class DefaultSerialization {
  ...
  DefaultSerialization()
      : _instance = callConstructor(getProperty(_npmPackage, 'DefaultSerialization'), []);
...
class Serializer {
  ...
  Serializer(DefaultSerialization serializationImpl, dynamic binaryEncoder)
      : _instance = callConstructor(getProperty(_npmPackage, 'Serializer'), [serializationImpl._instance, binaryEncoder]);
...
class Client {
  ...
  Client(dynamic adapter, dynamic options)
      : _instance = callConstructor(getProperty(_npmPackage, 'Client'), [adapter, options]);
...
class Server {
  ...
  Server(dynamic uApiSchema, dynamic handler, dynamic options)
      : _instance = callConstructor(getProperty(_npmPackage, 'Server'), [uApiSchema, handler, options]);
...
class MockServer {
  ...
  MockServer(dynamic mockUApiSchema, dynamic options)
      : _instance = callConstructor(getProperty(_npmPackage, 'MockServer'), [mockUApiSchema, options]);
...
class Message {
  ...
  Message(dynamic headers, dynamic body)
      : _instance = callConstructor(getProperty(_npmPackage, 'Message'), [headers, body]);
...
class ValidationFailure {
  ...
  ValidationFailure(dynamic path, String reason, dynamic data)
      : _instance = callConstructor(getProperty(_npmPackage, 'ValidationFailure'), [path, reason, data]);
}
...
class UApiSchema {
  ...
  UApiSchema(dynamic original, dynamic full, dynamic parsed, dynamic parsedRequestHeaders, dynamic parsedResponseHeaders)
      : _instance = callConstructor(getProperty(_npmPackage, 'UApiSchema'), [original, full, parsed, parsedRequestHeaders, parsedResponseHeaders]);

  static UApiSchema fromJson(dynamic json) {
    return UApiSchema(callMethod(getProperty(_npmPackage, 'UApiSchema'), 'fromJson', [json]));
  }

  static UApiSchema fromFileJsonMap(dynamic fileJsonMap) {
    return UApiSchema(callMethod(getProperty(_npmPackage, 'UApiSchema'), 'fromFileJsonMap', [fileJsonMap]));
  }

  static UApiSchema fromDirectory(String directory, dynamic fs, dynamic path) {
    return UApiSchema(callMethod(getProperty(_npmPackage, 'UApiSchema'), 'fromDirectory', [directory, fs, path]));
  }
}
...
class UApiSchemaParseError {
  ...
  UApiSchemaParseError(List<dynamic> schemaParseFailures, Map<String, dynamic> documentNamesToJson, dynamic cause)
      : _instance = callConstructor(getProperty(_npmPackage, 'UApiSchemaParseError'), [schemaParseFailures, documentNamesToJson, cause]);
}
...
class MockUApiSchema {
  ...
  MockUApiSchema(dynamic original, dynamic full, dynamic parsed, dynamic parsedRequestHeaders, dynamic parsedResponseHeaders)
      : _instance = callConstructor(getProperty(_npmPackage, 'MockUApiSchema'), [original, full, parsed, parsedRequestHeaders, parsedResponseHeaders]);

  static MockUApiSchema fromJson(dynamic json) {
    return MockUApiSchema(callMethod(getProperty(_npmPackage, 'MockUApiSchema'), 'fromJson', [json]));
  }

  static MockUApiSchema fromFileJsonMap(dynamic jsonDocuments) {
    return MockUApiSchema(callMethod(getProperty(_npmPackage, 'MockUApiSchema'), 'fromFileJsonMap', [jsonDocuments]));
  }

  static MockUApiSchema fromDirectory(String directory, dynamic fs, dynamic path) {
    return MockUApiSchema(callMethod(getProperty(_npmPackage, 'MockUApiSchema'), 'fromDirectory', [directory, fs, path]));
  }
}
...
class BinaryEncoderUnavailableError {
  ...
  BinaryEncoderUnavailableError(String message)
      : _instance = callConstructor(getProperty(_npmPackage, 'BinaryEncoderUnavailableError'), [message]);
}
...
class SerializationError {
  ...
  SerializationError(dynamic cause)
      : _instance = callConstructor(getProperty(_npmPackage, 'SerializationError'), [cause]);
}
...
class UApiError {
  ...
  UApiError(dynamic arg)
      : _instance = callConstructor(getProperty(_npmPackage, 'UApiError'), [arg]);
}
...
class MockServerOptions {
  ...
  MockServerOptions()
      : _instance = callConstructor(getProperty(_npmPackage, 'MockServerOptions'), []);
}
...
class ServerOptions {
  ...
  ServerOptions()
      : _instance = callConstructor(getProperty(_npmPackage, 'ServerOptions'), []);
}
...
class ClientOptions {
  ...
  ClientOptions()
      : _instance = callConstructor(getProperty(_npmPackage, 'ClientOptions'), []);
}
