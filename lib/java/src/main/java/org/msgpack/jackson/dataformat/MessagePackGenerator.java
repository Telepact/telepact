...
public class MessagePackGenerator
    ...
    private void pack(Object v)
        ...
        if (v == null) {
            ...
            MessagePackGenerator messagePackGenerator = new MessagePackGenerator(getFeatureMask(), getCodec(),
                    outputStream, packerConfig, false);
        ...
        if (failedToPackAsBI) {
            ...
            if (!decimal.stripTrailingZeros().toEngineeringString().equals(
                ...
                throw new IllegalArgumentException(
                        "MessagePack cannot serialize a BigDecimal that can't be represented as double. " + decimal);
            }
    ...
    public void writeNumber(String encodedValue)
        ...
        // There is a room to improve this API's performance while the implementation is
        // robust.
