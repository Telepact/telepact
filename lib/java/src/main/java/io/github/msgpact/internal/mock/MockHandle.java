...
import static io.github.msgpact.internal.mock.IsSubMap.isSubMap;
import static io.github.msgpact.internal.mock.Verify.verify;
import static io.github.msgpact.internal.mock.VerifyNoMoreInteractions.verifyNoMoreInteractions;
...
public class MockHandle {
    public static Message mockHandle(Message requestMessage, List<MockStub> stubs, List<MockInvocation> invocations,
            RandomGenerator random, MsgPactSchema msgPactSchema, boolean enableGeneratedDefaultStub,
        ...
        switch (functionName) {
            ...
            default -> {
                ...
                final var definition = (VFn) msgPactSchema.parsed.get(functionName);
                ...
                if (definition != null) {
                    ...
                    throw new MsgPactError("Unexpected unknown function: %s".formatted(functionName));
                }
            }
        }
    }
