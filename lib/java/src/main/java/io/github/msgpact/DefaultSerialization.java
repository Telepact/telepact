...
class DefaultSerialization implements Serialization {
    ...
    @Override
    public byte[] toJson(Object msgpactMessage) throws Throwable {
        return jsonMapper.writeValueAsBytes(msgpactMessage);
    }

    public byte[] toMsgPack(Object msgpactMessage) throws Throwable {
        return binaryMapper.writeValueAsBytes(msgpactMessage);
    }
