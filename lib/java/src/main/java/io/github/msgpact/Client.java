...
import static io.github.msgpact.internal.ProcessRequestObject.processRequestObject;

import java.util.concurrent.Future;
import java.util.function.BiFunction;

import io.github.msgpact.internal.binary.ClientBinaryEncoder;
...
public class Client {
    ...
    /**
     * Submit a msgPact Request Message. Returns a msgPact Response Message.
     * 
     * @param request
     * @return
     */
