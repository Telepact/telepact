...
public class DefaultBinaryEncodingCache implements BinaryEncodingCache {
    ...
    public void add(int checksum, Map<String, Integer> binaryEncodingMap, List<Object> packSites) {
        BinaryEncoding binaryEncoding = new BinaryEncoding(binaryEncodingMap, checksum, packSites);
