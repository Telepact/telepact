...
DOCS_PAGE_BLUEPRINTS = (
    ...
    },
    {
        ...
        "sections": (
            {"source": "doc/learn-by-example/getting-started/installation.md"},
            {"source": "doc/learn-by-example/getting-started/ping.md"},
            {"source": "doc/learn-by-example/getting-started/schema-and-add.md"},
            {"source": "doc/learn-by-example/getting-started/data-type-validation.md"},
            {"source": "doc/learn-by-example/schema/scalar-types.md"},
            {"source": "doc/learn-by-example/schema/collection-types.md"},
            {"source": "doc/learn-by-example/schema/structs.md"},
            {"source": "doc/learn-by-example/schema/unions.md"},
            {"source": "doc/learn-by-example/schema/functions.md"},
            {"source": "doc/learn-by-example/schema/service-errors.md"},
            {"source": "doc/learn-by-example/schema/headers.md"},
            {"source": "doc/learn-by-example/schema/comments.md"},
            {"source": "doc/learn-by-example/opt-in-features/select.md"},
            {"source": "doc/learn-by-example/opt-in-features/binary.md"},
            {"source": "doc/learn-by-example/mocking-an-integration/mock-server.md"},
            {"source": "doc/learn-by-example/mocking-an-integration/stock-mock.md"},
            {"source": "doc/learn-by-example/mocking-an-integration/stubs.md"},
            {"source": "doc/learn-by-example/mocking-an-integration/verify.md"},
            {"source": "doc/learn-by-example/auth/auth.md"},
            {"source": "doc/learn-by-example/using-telepact-client-library-code/minimum-python-client.md"},
            {"source": "doc/learn-by-example/using-telepact-client-library-code/automatic-binary-negotiation.md"},
            {"source": "doc/learn-by-example/code-generation/code-generation.md"},
            {"source": "doc/learn-by-example/running-our-own-server/minimum-server.md"},
            {"source": "doc/learn-by-example/running-our-own-server/logging.md"},
            {"source": "doc/learn-by-example/running-our-own-server/server-auth.md"},
            {"source": "doc/learn-by-example/running-our-own-server/managed-auth.md"},
            {"source": "doc/learn-by-example/running-our-own-server/schema-evolution.md"},
            {"source": "doc/learn-by-example/running-our-own-server/test-client-tdd.md"},
            {"source": "doc/learn-by-example/running-our-own-server/server-best-practices.md"},
        ),
    },
    {
