...
cases = {
    ...
    'multipleFailures': [
        [[{}, {'fn.test': {'value': {'struct': {'optional': 'wrong', 'a': False}}}}], [{'_setCompare': True}, {'_ErrorInvalidRequestBody': {'cases': [{'path': ['fn.test', 'value', 'struct', 'optional'], 'reason': {'TypeUnexpected': {'actual': {'String': {}}, 'expected': {'Boolean': {}}}}}, {'path': ['fn.test', 'value', 'struct', 'required'], 'reason': {'RequiredStructFieldMissing': {}}}, {'path': ['fn.test', 'value', 'struct', 'a'], 'reason': {'StructFieldUnknown': {}}}]}}]],
    ],
    'api': [
