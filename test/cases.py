...
cases = {
    ...
    'testSelectFields': [
        ...
        [[{'_sel': {'': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', ''], 'reason': {'TypeUnknown': {}}}]}}]],
        [[{'_sel': {'notStruct': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'notStruct'], 'reason': {'TypeUnknown': {}}}]}}]],
        [[{'_sel': {'struct.Unknown': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'struct.Unknown'], 'reason': {'TypeUnknown': {}}}]}}]],
        [[{'_sel': {'fn.notKnown': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'fn.notKnown'], 'reason': {'TypeUnknown': {}}}]}}]],
        ...
        [[{'_sel': {'struct.ExStruct': ['unknownField']}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'struct.ExStruct', 0], 'reason': {'StructFieldUnknown': {}}}]}}]],
        ...
        [[{'_sel': {'union.ExUnion': {'Unknown': {}}}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'union.ExUnion', 'Unknown'], 'reason': {'UnionCaseUnknown': {}}}]}}]],
