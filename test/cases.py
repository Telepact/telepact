...
cases = {
    ...
    'testSelectFields': [
        ...
        [[{'_sel': {'': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', ''], 'reason': {'StructUnknown': {}}}]}}]],
        [[{'_sel': {'notStruct': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'notStruct'], 'reason': {'StructUnknown': {}}}]}}]],
        [[{'_sel': {'struct.Unknown': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'struct.Unknown'], 'reason': {'StructUnknown': {}}}]}}]],
        [[{'_sel': {'fn.notKnown': []}}, {'fn.test': {}}], [{'_assert': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'_ErrorInvalidRequestHeaders': {'cases': [{'path': ['_sel', 'fn.notKnown'], 'reason': {'StructUnknown': {}}}]}}]],
