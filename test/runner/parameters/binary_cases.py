...
_BINARY_PACK_SITES = [[['Ok_', 'data'], [None, 'id', 'name']]]
_BINARY_CHECKSUM = 375778639

cases = {
    'binary': [
        [[{'@bin_': []}, {'fn.ping_': {}}], [{'@enc_': _BINARY_ENCODING, '@encp_': _BINARY_PACK_SITES, '@bin_': [_BINARY_CHECKSUM]}, {0: {}}]],
