                                     ...
                                     [{},
                                      {'Ok_': {'api': [{'info.ApiExamplesMock': {}, 'example': {}},
                                                       ...
                                                       {'///': [' The `@bin_` header indicates the valid checksums of binary encodings            ',
                                                        ...
                                                        '->': {'@bin_': ['integer'], '@enc_': {'string': 'integer'}, '@encp_': {'string': 'any'}, '@pac_': 'boolean'},
                                                        'inputExample': {'@bin_': [2163713, 3178529], '@pac_': False},
                                                        'outputExample': {'@bin_': [16303881, 954081041],
                                                                          '@enc_': {'lambda': 415302837, 'xi': 589180268},
                                                                          '@encp_': {'kappa': 'tau', 'beta': 'xi'},
                                                                          '@pac_': True}},
