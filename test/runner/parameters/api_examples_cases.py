                                     ...
                                     [{},
                                      {'Ok_': {'api': [{'info.ApiExamplesMock': {}, 'example': {}},
                                                       ...
                                                       {'///': [' The `@bin_` header indicates the valid checksums of binary encodings            ',
                                                                ...
                                                                ' names to field ids, and an `@pck_` header containing the precomputed packed    ',
                                                                ' binary sites and row headers. The response body may also be encoded in binary. ',
                                                                '                                                                                 ',
                                                        ...
                                                        '->': {'@bin_': ['integer'], '@enc_': {'string': 'integer'}, '@pck_': [['any']], '@pac_': 'boolean'},
                                                        'inputExample': {'@bin_': [2163713, 3178529], '@pac_': False},
                                                        'outputExample': {'@bin_': [16303881, 954081041], '@enc_': {'lambda': 415302837, 'xi': 589180268}, '@pck_': [['tau', 1326349322], [225740852, False]], '@pac_': True}},
