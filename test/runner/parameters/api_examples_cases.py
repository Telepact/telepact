                                     ...
                                     [{},
                                      {'Ok_': {'api': [{'info.ApiExamplesMock': {}, 'example': {}},
                                                       ...
                                                       {'///': [' Verify a call was made with this mock that matches the given `call` and         ',
                                                        ...
                                                        'headers.Binary_': {'@bin_': ['integer']},
                                                        '->': {'@bin_': ['integer'], '@enc_': {'string': 'integer'}},
                                                        'inputExample': {'@bin_': [2163713, 3178529]},
                                                        'outputExample': {'@bin_': [16303881, 954081041], '@enc_': {'lambda': 415302837, 'xi': 589180268}}},
