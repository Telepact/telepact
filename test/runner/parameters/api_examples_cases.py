                                     ...
                                     [{},
                                      {'Ok_': {'api': [{'info.ApiExamplesMock': {}, 'example': {}},
                                                       ...
                                                       {'///': [' The `@bin_` header indicates the valid checksums of binary encodings            ',
                                                                ...
                                                                ' names to field ids, along with an `@encp_` header containing the pre-compiled   ',
                                                                ' packed-binary sites for that encoding. The response body may also be encoded in ',
                                                                ' binary.                                                                         ',
                                                                '                                                                                 ',
                                                        ...
                                                        'outputExample': {'@bin_': [16303881, 954081041], '@enc_': {'lambda': 415302837, 'xi': 589180268}, '@encp_': True, '@pac_': False}},
