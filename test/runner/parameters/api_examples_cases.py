                                      ...
                                      {'Ok_': {'api': [{'info.ApiExamplesMock': {}, 'example': {}},
                                                       ...
                                                       {'///': [' The `@bin_` header indicates the valid checksums of binary encodings            ',
                                                                ...
                                                                " provided checksum does not match the server's checksum, the server will also    ",
                                                                 ' send an `@enc_` header containing a compiled binary-plan descriptor. The        ',
                                                                 ' response body may also be encoded in binary.                                    ',
                                                                '                                                                                 ',
                                                        ...
                                                        '->': {'@bin_': ['integer'], '@enc_': 'any', '@pac_': 'boolean'},
                                                        'inputExample': {'@bin_': [2163713, 3178529], '@pac_': False},
                                                        'outputExample': {'@bin_': [16303881, 954081041], '@enc_': {'v': 1, 'p': 3178529, 'k': ['lambda', 'xi'], 'q': [], 's': []}, '@pac_': True}},
