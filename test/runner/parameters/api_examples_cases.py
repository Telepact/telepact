                                                       ...
                                                       {'///': [' Verify a call was made with this mock that matches the given `call` and         ',
                                                        ...
                                                        'outputExample': {'ErrorUnknown_': {'caseId': 'phi'}}},
                                                           {'///': [' The `@bin_` header indicates the valid checksums of binary encodings            ',
                                                            ...
                                                            ' names to field ids, and an `@encp_` header containing the precompiled packed    ',
                                                            ' binary site tree for that same encoding, keyed first by function name and then  ',
                                                            ' by response-path traversal. The response body may also be encoded in binary.    ',
                                                            ' binary.                                                                         ',
                                                                '                                                                                 ',
                                                        ...
                                                        '->': {'@bin_': ['integer'], '@enc_': {'string': 'integer'}, '@encp_': ['any'], '@pac_': 'boolean'},
                                                        'inputExample': {'@bin_': [2163713, 3178529], '@pac_': False},
                                                        'outputExample': {'@bin_': [16303881, 954081041], '@enc_': {'lambda': 415302837, 'xi': 589180268}, '@encp_': {'fn.functionName': {'->': {'Ok_': {'data': [None, 'id', 'name']}}}}, '@pac_': True}},
