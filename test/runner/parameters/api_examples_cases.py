                                                       ...
                                                       {'///': [' Verify a call was made with this mock that matches the given `call` and         ',
                                                        ...
                                                        'outputExample': {'ErrorUnknown_': {'caseId': 'phi'}}},
                                                           {'///': [' The `@bin_` header indicates the valid checksums of binary encodings            ',
                                                            ...
                                                            ' binary sites for that same encoding. The response body may also be encoded in   ',
                                                            ' binary.                                                                         ',
                                                                '                                                                                 ',
                                                        ...
                                                        'outputExample': {'@bin_': [16303881, 954081041], '@enc_': {'lambda': 415302837, 'xi': 589180268}, '@encp_': [[['Ok_', 'data'], [None, 'id', 'name']]], '@pac_': True}},
