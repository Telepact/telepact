...
cases = {
    ...
    'testSelectFields': [
        ...
        [[{'@select_': {'->': {'Ok_': ['next!']}, 'struct.FollowUpDetails': ['kept']}, '@ok_': {'next!': {'fn.getFollowUp': {'id': 'follow-up-1', 'details': {'kept': 'Ship docs', 'extra': 'for follow-up execution'}}}}}, {'fn.createIssueLink': {'title': 'Ship docs'}}], [{}, {'Ok_': {'next!': {'fn.getFollowUp': {'id': 'follow-up-1', 'details': {'kept': 'Ship docs', 'extra': 'for follow-up execution'}}}}}]],
        [[{'@select_': {'->': {'Ok_': ['todo', 'next!']}, 'struct.Todo': [], 'struct.FollowUpDetails': ['kept']}, '@ok_': {'todo': {'title': 'Ship docs'}, 'next!': {'fn.getFollowUp': {'id': 'follow-up-1', 'details': {'kept': 'Ship docs', 'extra': 'for follow-up execution'}}}}}, {'fn.createIssueLink': {'title': 'Ship docs'}}], [{}, {'Ok_': {'todo': {}, 'next!': {'fn.getFollowUp': {'id': 'follow-up-1', 'details': {'kept': 'Ship docs', 'extra': 'for follow-up execution'}}}}}]],
    ...
    'api': [
        [[{}, {'fn.api_': {}}], [{}, {'Ok_': {'api': _EXAMPLE_PUBLIC_SCHEMA}}]],
    ...
    'serverHooks': [
        ...
        [[{'@ok_': {}, '@throwError_': True, '@assertOnErrorNested_': True}, {'fn.test': {}}], [{'@assert_': {'assertCaseId': True}}, {'ErrorUnknown_': {'caseId': '<caseId>'}}]],
        [[{'@ok_': {}, '@responseHeader': {'@out': 0}, '@assertOnErrorStandalone_': True}, {'fn.test': {}}], [{'@assert_': {'skipBinaryCheck': True, 'skipFieldIdCheck': True}}, {'ErrorInvalidResponseHeaders_': {'cases': [{'path': ['@out'], 'reason': {'TypeUnexpected': {'actual': {'Number': {}}, 'expected': {'Boolean': {}}}}}]}}]],
    ],
    'clientHeaders': [
