...
cases = {
    ...
    'testSelectFields': [
        ...
        [[{'@select_': {'->': {'Ok_': ['next']}, 'struct.LinkCard': ['shown']}, '@ok_': {'next': {'fn.linkCard': {'card': {'shown': False, 'hidden': False}}}}}, {'fn.linkEnvelope': {}}], [{}, {'Ok_': {'next': {'fn.linkCard': {'card': {'shown': False, 'hidden': False}}}}}]],
