...
cases = {
    ...
    'optionalWireKeyHint': [
        [[{}, {'fn.test': {'value!': {'struct!': {'required': True, 'optional': False}}}}], [{'@assert_': {'setCompare': True}}, {'ErrorInvalidRequestBody_': {'cases': [{'path': ['fn.test', 'value!', 'struct!', 'optional'], 'reason': {'ObjectKeyDisallowed': {}}}, {'path': ['fn.test', 'value!', 'struct!', 'optional'], 'reason': {'ExtensionValidationFailed': {'reason': 'Optional struct fields keep the ! suffix on the wire; prefer generated helpers to set them.', 'data!': {'receivedKey': 'optional', 'expectedWireKey': 'optional!'}}}}]}}]],
    ],
    'api': [
