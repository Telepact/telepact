...
def load_binary_server_proc(loop, transport_client, dispatcher_server):
    lib_name = dispatcher_server

    init_topics = ['client-frontdoor', 'frontdoor']
    topics = tuple('{}.{}.{}'.format(lib_name, 'load-binary', t)
    ...
    print('load_binary_server_proc stopped')


def test_load_binary_case(loop, load_binary_server_proc, transport_client):
