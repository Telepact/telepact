...
import io.github.msgpact.Client;
import io.github.msgpact.Message;
import io.github.msgpact.MockServer;
import io.github.msgpact.MockMsgPactSchema;
import io.github.msgpact.SerializationError;
import io.github.msgpact.Serializer;
import io.github.msgpact.Server;
import io.github.msgpact.MsgPactSchema;
import io.github.msgpact.MsgPactSchemaParseError;
import msgpacttest.ClientInterface_;
import msgpacttest.test;
import io.github.msgpact.MsgPactSchemaFiles;
...
public class Main {
    ...
    public static Dispatcher startMockTestServer(io.nats.client.Connection connection, MetricRegistry metrics,
            ...
            throws IOException, InterruptedException {
        var msgPact = MockMsgPactSchema.fromDirectory(apiSchemaPath);
        ...
        var server = new MockServer(msgPact, options);
    ...
    public static Dispatcher startSchemaTestServer(io.nats.client.Connection connection, MetricRegistry metrics,
            ...
            String frontdoorTopic)
            throws IOException, InterruptedException {
        var msgPact = MsgPactSchema.fromDirectory(apiSchemaPath);
        var objectMapper = new ObjectMapper();
        ...
        Function<Message, Message> handler = (requestMessage) -> {
            ...
            try {
                if (inputTag.equals("PseudoJson")) {
                    ...
                    if (extendJson != null) {
                        MsgPactSchema.fromFileJsonMap(Map.of("default", schemaJson, "extend", extendJson));
                    } else {
                    ...
                    MsgPactSchema.fromDirectory(schemaPath);
                } else {
        ...
        var server = new Server(msgPact, handler, options);
    ...
    public static Dispatcher startTestServer(io.nats.client.Connection connection, MetricRegistry metrics,
            ...
            throws IOException, InterruptedException {
        var files = new MsgPactSchemaFiles(apiSchemaPath);
        ...
        var msgPact = MsgPactSchema.fromFileJsonMap(files.filenamesToJson);
        var alternateMsgPact = MsgPactSchema.fromFileJsonMap(alternateMap);
        ...
        var alternateServer = new Server(alternateMsgPact, handler, alternateOptions);
