...
import msgpacttest.ExStruct;
import msgpacttest.ExUnion;
import msgpacttest.ServerHandler_;
import msgpacttest.TypedMessage_;
import msgpacttest.Value;
import msgpacttest.example;
import msgpacttest.test;
import msgpacttest.example.Input;
import msgpacttest.example.Output;
...
public class CodeGenHandler extends ServerHandler_ {
    ...
    @Override
    public TypedMessage_<msgpacttest.test.Output> test(Map<String, Object> headers, msgpacttest.test.Input input) {
        try {
    ...
    @Override
    public TypedMessage_<msgpacttest.getBigList.Output> getBigList(Map<String, Object> headers,
            msgpacttest.getBigList.Input input) {
        // TODO Auto-generated method stub
