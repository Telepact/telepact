...
def _generated_file_header(file_name: str) -> str:
    suffix = Path(file_name).suffix
    if suffix == '.py':
        return '# Code generated by the Telepact CLI. DO NOT EDIT BY HAND.\n'
    if suffix in {'.java', '.ts', '.go'}:
        return '// Code generated by the Telepact CLI. DO NOT EDIT BY HAND.\n'
    raise ValueError(f'Unsupported generated file type: {file_name}')


def _prepend_generated_file_header(file_name: str, content: str) -> str:
    header = _generated_file_header(file_name)
...
def _generate_internal(schema_data: list[dict[str, object]], possible_fn_selects: dict[str, object], target: str, output_dir: str, package_name: str) -> None:
    ...
    if target == "java":
        ...
        def _write_java_file(jinja_file: str, input: dict, output_file: str) -> None:
            ...
            output = _prepend_generated_file_header(
        ...
        output = _prepend_generated_file_header('gen_types.py', output)
        ...
        if output_dir:
            ...
            with init_file_path.open("w") as f:
                f.write(_prepend_generated_file_header("__init__.py", ""))
        ...
        output = _prepend_generated_file_header('genTypes.ts', output)
        ...
        output = _prepend_generated_file_header('generated.go', output)
