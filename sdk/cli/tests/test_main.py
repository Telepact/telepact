...
def test_command_java(runner: CliRunner) -> None:
    output_dir = Path('tests/output/java')
    result = runner.invoke(
        main, ['codegen', '--schema-dir', 'tests/data', '--lang', 'java', '--out', str(output_dir), '--package', 'output'])
    ...
    generated = (output_dir / 'test.java').read_text()
    generated_nested = (output_dir / 'selectNested.java').read_text()
    for generated_file in output_dir.glob('*.java'):
        assert generated_file.read_text().startswith('// Code generated by the Telepact CLI. DO NOT EDIT BY HAND.\n')
...
def test_command_py(runner: CliRunner) -> None:
    output_dir = Path('tests/output/py')
    result = runner.invoke(
        main, ['codegen', '--schema-dir', 'tests/data', '--lang', 'py', '--out', str(output_dir)])
    ...
    generated = (output_dir / 'gen_types.py').read_text()
    assert generated.startswith('# Code generated by the Telepact CLI. DO NOT EDIT BY HAND.\n')
...
def test_command_ts(runner: CliRunner) -> None:
    output_dir = Path('tests/output/ts')
    result = runner.invoke(
        main, ['codegen', '--schema-dir', 'tests/data', '--lang', 'ts', '--out', str(output_dir)])
    ...
    generated = (output_dir / 'genTypes.ts').read_text()
    assert generated.startswith('// Code generated by the Telepact CLI. DO NOT EDIT BY HAND.\n')
    assert 'export namespace ' not in generated
    assert '}static ' not in generated
    assert '}ok' not in generated
    assert 'export const test = {' in generated
    assert 'export class TestInput {' in generated
    assert 'export class TestOutput {' in generated
    assert 'async test(_headers: Record<string, any>, _input: TestInput)' in generated
...
def test_command_go(runner: CliRunner) -> None:
    ...
    generated = (output_dir / 'generated.go').read_text()
    assert generated.startswith('// Code generated by the Telepact CLI. DO NOT EDIT BY HAND.\n')
    assert 'package output' in generated
