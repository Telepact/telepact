...
def test_command_ts(runner: CliRunner) -> None:
    ...
    assert 'Raw wire-aligned payload. Optional fields keep the `!` suffix here; prefer' in generated
    assert 'long?: string | undefined' in generated
    assert 'if (long !== undefined) {' in generated
    assert 'input["long!"] = long;' in generated
