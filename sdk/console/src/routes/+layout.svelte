				...
				<div class="flex items-center rounded-md py-2">
					<div class="text-sky-400">
						...
						>
							...
							<g class="text-yellow-500 dark:text-yellow-300">
								<path d="M 10 17 L 15 10 L 15 12 L 19 8 L 19.008 9.317 L 23 6 L 18 13 L 18 11 L 14 15 L 13.996 13.561 L 10 17"/>
							</g>
<!-- 
							<path d="M 2.093 6.908 C 0.414 4.35 1.447 0.938 3 1 C 3.67 1.171 3.799 1.352 4.057 1.946 C 4.833 4.117 4 11 2 23 L 16 23 M 18 2 A 1 1 0 0 0 17 1 L 3 1 M 18 2 L 18 5 M 16 23 C 16.619 20.297 16.817 18.695 17.138 16.558"/>
							<g class="text-yellow-300">
								<path d="M 10 17 L 14 8 L 17 11 L 23 6 L 19 15 L 16 12 L 10 17"/>
							</g>							 -->
						</svg>
					</div>
