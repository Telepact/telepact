...
void main() {
  group('Server', () {
    test('cleaner: should work e2e from client to server', () async {
      ...
      //final exampleLocalStorageData = {"-608298151":{"Ok_":0,"api":1,"example!":2,"fn.add":3,"fn.api_":4,"fn.def_":5,"fn.example_":6,"fn.index_":7,"fn.ping_":8,"includeInternal!":9,"inputExample!":10,"outputExample!":11,"result":12,"schemaKey":13,"x":14,"y":15}};
