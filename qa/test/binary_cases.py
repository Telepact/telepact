...
cases = {
    'binary': [
        ...
        [[{'msgpack': True, 'bin_': [1218031367], '_pac': True, 'Ok': {'data': [{'id': 1, 'name': 'one'}, {'id': 2, 'name': 'two'}]}}, {40: {}}], [{'bin_': [1218031367], '_pac': True}, {27: {36: [ExtType(17, b''), [None, 42, 44], [1, 'one'], [2, 'two']]}}]],
